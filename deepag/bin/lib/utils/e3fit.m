%E3FIT    Pajdla: Finds E(3) transformation minimizing LMSq/LSQ distance between two data sets
%	
%
%       function [E,Ve,rW,res,rs,rres,dX] = e3fit(X1,X2,W,mode,par)
%	
...
%	rW		= weihts after outlier edetection, outliers have weight 0
%	res		= residuals
...
%       Status       : Ready ($Source: /home/cvs/Matlab/utils/e3fit.m,v $)
%
function [E,Ve,W,res,rs,rres,dXt] = e3fit(X1,X2,W,mode,par) 
