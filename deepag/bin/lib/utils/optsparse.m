function [conf, args] = optsparse(conf, args, varargin) 
% OPTSPARSE = copy of VLFAT VL_ARGPARSE:  Parse list of parameter-value pairs
%
%   CONF = OPTSPARSE(CONF, ARGS) updates the structure CONF based on
%   the specified parameter-value pairs ARGS={PAR1, VAL1, ... PARN,
%   VALN}. The function produces an error if an unknown parameter name
%   is passed in.
%
%   [CONF, ARGS] = OPTSPARSE(CONF, ARGS) copies any parameter in
...
% All rights reserved.
% 2015-05-14 adapted by T. Pajdla, pajdla@cmp.felk.cvut.cz
%
% This file is a renamed copy of the VLFeat library, 
% See VLFeat for license.
